...
function displayResult(attri){
    ...
    // console.log(idx);
    document.getElementById("state-confirmed").innerHTML=confirmed[idx];
    document.getElementById("state-active").innerHTML=active[idx];
    document.getElementById("state-recovered").innerHTML=discharged[idx];
    document.getElementById("state-deceased").innerHTML=deceased[idx];
